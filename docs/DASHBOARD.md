...
- On 2026-09-26, the owner requested the bot prompt-layer inspector in assembly order, with compaction separated
  from generation. Names expand template/source details in place; applicability
  labels explain role/plugin/turn conditions independently of layer checkboxes.
  Keep the compact layout and draft safety. See [PROMPTS.md](PROMPTS.md) for the
  inspection contract; ordinary inventories and template selectors remain A–Z.
